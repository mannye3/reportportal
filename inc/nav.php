                    ...
                    <ul class="vertical-menu">
                        <li>
                         ...
                         <li>
                            <a href="javaScript:void();">
                                <img src="assets/images/svg-icon/tables.svg" class="img-fluid" alt="tables"><span>Trade Report</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                       ...
                       <!--  <li>
                            ...
                            <ul class="vertical-submenu">
                                ...
                                <li><a href="http://xpanthersolutions.com/admin-templates/orbiter/html/light-horizontal/index.html">Light - Horizontal</a></li>
                                <li><a href="http://xpanthersolutions.com/admin-templates/orbiter/html/semi-dark-vertical/index.html">Semi Dark - Vertical</a></li>
                                <li><a href="http://xpanthersolutions.com/admin-templates/orbiter/html/light-boxed-vertical/index.html">Boxed - Vertical</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javaScript:void();">
